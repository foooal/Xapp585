...
add wave -noupdate -divider -height 25 {Simulation Constants}
...
add wave -noupdate -divider -height 25 {UUT - DTU Connections}
add wave -noupdate -divider Transmitter
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_tx_freqgen_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_tx_freqgen_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkout1_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkout1_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_dataout1_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_dataout1_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkout2_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkout2_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_dataout2_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_dataout2_n
add wave -noupdate -divider Receiver
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkin1_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkin1_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_datain1_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_datain1_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkin2_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_clkin2_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_datain2_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_datain2_n
add wave -noupdate -divider Stuff
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_refclkin_p
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_refclkin_n
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_rx_dummy
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_i2c_data
add wave -noupdate /txrx_5x2_7to1_appslevel_testbench/Sim_i2c_clock
...
WaveRestoreCursors {{Cursor 1} {18367631 ps} 0}
...
update
WaveRestoreZoom {0 ps} {303822220 ps}
